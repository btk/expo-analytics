...
export default class Analytics {
    ...
    constructor(propertyId, additionalParameters = {}, options = defaultOptions){
        ...
        this.parameters = {
            an: Constants.manifest ? Constants.manifest.name : additionalParameters.name,
            aid: Constants.manifest ? Constants.manifest.slug : additionalParameters.slug,
            av: Constants.manifest ? Constants.manifest.version : additionalParameters.version,
            sr: `${width}x${height}`,
